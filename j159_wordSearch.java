public class j159_wordSearch {
    public static boolean exist(char[][] board, String word) {
     ...
     public static boolean wordSearch(char[][] board , int i , int j , String word , boolean[][] board2){
        if(word.isEmpty()){
            return true;
        }
...
//            for right traversal
    ...
    public static void main(String[] args) {
        ...
        boolean [][] board2 = new boolean[board.length][board[0].length];
        System.out.println(wordSearch(board, 0, 0, "ABCCED", board2));
    }
}
